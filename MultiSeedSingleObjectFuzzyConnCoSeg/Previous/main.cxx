...
int main( int argc, char * argv[] )
{
  if( argc < 9 )
    {
      ...
      std::cerr << argv[0] << " seedFile outputImageFile CTImageFile PETImageFile CTSigma PETSigma CTMean PETMean" << std::endl;
      return EXIT_FAILURE;
    }
  ...
  kFOEMS( inputImage, spacing, sigma, mean, seed, seedCount, fuzzyConImage);
  std::cout <<"finished"<<std::endl;
  std::cout<<std::endl;
  //Set output
