...
int main( int argc, char * argv[] )
{
  if( argc < 7 )
    {
      ...
      std::cerr << argv[0] << " seedFile outputImageFile inputImageFile sigma mean mode(1:normal(attenuate both sides) 2:bright ohj 3:dark obj)" << std::endl;
      return EXIT_FAILURE;
    }
  ...
  kFOEMS( inputImage, spacing, sigma, mean, seed, seedCount, fuzzyConImage, mode);
  std::cout <<"finished"<<std::endl;
  std::cout<<std::endl;
  //Set output
