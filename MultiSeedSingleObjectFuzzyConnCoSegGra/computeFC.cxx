...
void kFOEMS(VectorType * inputImage, ImageType::SpacingType spacing, VectorType sigma, unsigned int *seedList, unsigned int seedCount, unsigned int *fuzzyConImage)
{ 
  ...
  float CTAffinity, CTP, CTQ, CTPQ, CTSigma;
  float PETAffinity, PETP, PETQ, PETPQ, PETSigma;
  //Get value
  ...
  std::cout<<"CTSigma "<<CTSigma<<"; PETSigma "<<PETSigma<<std::endl;
