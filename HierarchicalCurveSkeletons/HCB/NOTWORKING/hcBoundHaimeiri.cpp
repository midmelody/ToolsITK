//
// This version uses an own method for calculating the eigenvectors
//	which does not work very well as it is written, but can be fixed
//	(cannot always choose x = 1)
...
void main(int argc, char *argv[]) {
	...
	Vector Ti, pmq, pd1, pd2;
	double sl, ki, length, wi, c, ca, cb, cc, t, delta, e1, e2, A, B, C, sinasq, cosa, k1, k2, maxk1, mink1;
	double Ma[3][3];
