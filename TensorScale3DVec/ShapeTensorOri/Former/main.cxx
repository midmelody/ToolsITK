...
int main(int argc, char *argv[])
{
  ...
  GraXImageReader->SetFileName( "temp/GradientDTXSmooth.img" );
  ...
  GraYImageReader->SetFileName( "temp/GradientDTYSmooth.img" );
  ...
  GraZImageReader->SetFileName( "temp/GradientDTZSmooth.img" );
  ...
  float norm;
  //Get tangent vector
  FindTangentOri(DT, vecOri, tangentOri1, tangentOri2);
