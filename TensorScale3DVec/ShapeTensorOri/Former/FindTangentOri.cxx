void FindTangentOri(float *DT, VOXEL *vecOri, VOXEL *tangentOri1, VOXEL *tangentOri2)
{
  ...
  float graX,graY;
  float temp;
  int specX1=50, specY1=13, specZ1=74;
  int specX2=46, specY2=15, specZ2=74;
  ...
  for(i=0;i<pRow;i++)
	...
	for(k=0;k<pSli;k++)
	  { 
	    ...
	    z = vecOri(i,j,k).z;
	    /////////////////////////////////////////////////////////////////////////////
	    if(((i==specX1)&&(j==specY1)&&(k==specZ1))||((i==specX2)&&(j==specY2)&&(k==specZ2)))
		...
		std::cout<<"Inplane: "<<graX<<" "<<graY<<std::endl;
	      }
	    /////////////////////////////////////////////////////////////////////////////
  ...
  for(i=0;i<pRow;i++)
      ...
      for(k=0;k<pSli;k++)
	{
	  ...
	  if(signf(smoothTangOri1(i,j,k).x)!=signf(tangentOri1(i,j,k).x))
	    if(signf(smoothTangOri1(i,j,k).y)!=signf(tangentOri1(i,j,k).y)) 
	      if(signf(smoothTangOri1(i,j,k).z)!=signf(tangentOri1(i,j,k).z)) 
		{
		  smoothTangOri1(i,j,k).x = - smoothTangOri1(i,j,k).x;
		  smoothTangOri1(i,j,k).y = - smoothTangOri1(i,j,k).y;
		  smoothTangOri1(i,j,k).z = - smoothTangOri1(i,j,k).z;
		}	  
	}
  ...
  for(i=0;i<pRow;i++)
      ...
      for(k=0;k<pSli;k++)
	{
	  ...
	  /////////////////////////////////////////////////////////////////////////////
	  if(((i==specX1)&&(j==specY1)&&(k==specZ1))||((i==specX2)&&(j==specY2)&&(k==specZ2)))
	    std::cout<<"Smoothed tang ori: "<<std::endl<<x1<<" "<<y1<<" "<<z1<<std::endl;
	  /////////////////////////////////////////////////////////////////////////////
